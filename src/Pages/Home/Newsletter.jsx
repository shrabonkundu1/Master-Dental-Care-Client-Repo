...
const Newsletter = () => {
  ...
  return (
    <div className="w-[90%] mx-auto flex items-center py-24">
      <div className="space-y-4  ">
        ...
        <p className="w-11/12 text-[18px] text-slate-500">
        ...
        <form onSubmit={handleSubscribe} className="flex ">
          <input
          type="email"
            className="border-2 rounded-l-lg pl-5 bg-gradient-to-r from-slate-100 to-blue-50 bg pr-80 py-4"
