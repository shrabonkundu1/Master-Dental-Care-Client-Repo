      ...
      <div className="card card-compact rounded-md group  px-1 py-2 border border-[#a0d6f3] bg-[#f3f7fd] hover:bg-white duration-1800 transition  hover:translate-y-[-4px]">
        ...
        <div className="card-body space-y-1">
          ...
          <div className="card-actions justify-end">
            <button className="w-full py-3 border rounded-lg  text-slate-50 bg-gradient-to-r  from-blue-600 to-blue-400  translate-2 transition-transform  font-bold hover:scale-105">Buy Now</button>
          </div>
        </div>
      </div>
    </div>
