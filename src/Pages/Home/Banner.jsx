            ...
            <div className="grid grid-cols-1 md:grid-cols-4 items-center min-h-[450px]  gap-28  p-5 rounded-lg ">
              <div className="space-y-8 col-span-2">
                <motion.h2
                  ...
                  className="md:text-5xl sm:text-4xl text-[32px] lg:text-5xl font-bold  leading-10"
                >
                  Transform
              ...
              <div className="col-span-2 flex ">
                ...
                <motion.img
                  ...
                  transition={{ duration: 4, delay: 0, repeat: Infinity }}
                  className=" w-[330px] h-52 rounded-t-[60px] rounded-r-[60px] border-l-8 border-b-8 absolute top-[220px] border-blue-600"
                  src={banner2}
                  alt=""
                />
              </div>
                  ...
                  <div className="space-y-5">
                    ...
                    >
                     <span className="mb-10 bg-gradient-to-r from-blue-200 to-blue-50 bg-clip-text text-transparent "> Transform
                      <span className="bg-gradient-to-r from-blue-300 to-blue-100 bg-clip-text text-transparent mx-5 ">
                        Your Smile
                      </span></span><br />
